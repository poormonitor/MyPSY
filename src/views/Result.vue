...
<template>
    <div class="bg-gradient-to-tl from-pink-200 to-rose-50 min-h-full overflow-hidden pb-10">
        <div class="xl:mx-40 lg:mx-24 md:mx-16 mx-10">
            <div class="content" v-if="testAnswered">
                <div id="title" class="mt-10 lg:mt-16">
                    ...
                    <div class="text-3xl lg:text-5xl my-1 lg:my-3 font-medium">{{ testContent.data.name }}</div>
                </div>
                <div id="score" class="mt-8 lg:mt-10">
                    <div v-for="gp in testContent.data.res.group.list.length"
                        ...
                        <span class="text-xl lg:text-3xl font-medium">{{ testContent.data.res.group.list[gp - 1] }}</span>
                    ...
                    <div
                        class="backdrop-blur-xl bg-white/50 shadow-2xl p-8 my-6 lg:my-12 rounded-3xl transition ease-in-out duration-300">
                        <span class="text-xl lg:text-3xl font-medium">分析提示</span>
